...
use App\Core\Models\Robotcodetype;

class RobotcodetypeManager extends BaseManager
{
    public function find($parameters = null)
    {
        return Robotcodetype::find($parameters);
    }

    public function findFirstById($id)
    {
        return Robotcodetype::findFirstById((int)$id);
    }
